...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('payments_types', function (Blueprint $table) { $table->dropColumn(['user_id']); });
    }
    ...
    public function down(): void
    {
        ...
        Schema::table('payments_types', function (Blueprint $table) { $table->integer('user_id'); });
    }
};
