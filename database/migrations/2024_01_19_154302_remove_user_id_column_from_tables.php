...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('payments_types', function (Blueprint $table) { $table->dropColumn(['workspace_id']); });
    }
    ...
    public function down(): void
    {
        ...
        Schema::table('payments_types', function (Blueprint $table) { $table->integer('workspace_id'); });
    }
};
