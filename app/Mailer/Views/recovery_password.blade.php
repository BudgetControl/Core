        ...
        <tr>
            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:20px 50px 50px;font-family:'Raleway',sans-serif;" align="left">
                <div class="v-text-align" align="left">
                    ...
                    <p>{{$link}}</p>
                    <p>You will be directed to a page where you can create a new password. Please choose a strong and secure password.</p>
                    <p>After setting your new password, click "Submit" or "Reset Password."</p>
                    <p>If you did not request a password reset, please ignore this email. Your account's security is important to us, and no changes have been made.</p>
                    <p>If you encounter any issues or need further assistance, please don't hesitate to contact our support team at [Support Email Address].</p>
                    <p>Thank you for using Budget Control, and we apologize for any inconvenience this may have caused.</p>
                    <p>Best regards,</p>
        ...
        <tr>
            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:20px 50px 50px;font-family:'Raleway',sans-serif;" align="left">
                ...
                <div class="v-text-align" style="font-size: 14px; line-height: 140%; text-align: justify; word-wrap: break-word;">
                    <p style="line-height: 140%;"><span style="line-height: 19.6px;"></span>This link will work for 2 hours or until you reset your password.<br /><br />Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text.<br /><br /><strong>Best Regards,</strong><br /><strong>Unlayer Team </strong></p>
                </div>
